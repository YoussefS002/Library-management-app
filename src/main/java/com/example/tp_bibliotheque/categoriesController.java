...
public class categoriesController {
    ...
    @FXML
    private TableColumn<Categorie, String> categorieColumn;
    @FXML
    private TableColumn<Categorie, Integer> dureeMaxColumn;
    @FXML
    private TableColumn<Categorie, Integer> empruntsMaxColumn;
    @FXML
    ...
    private void initialize() {
        categorieColumn.setCellValueFactory(new PropertyValueFactory<>("nom"));
        dureeMaxColumn.setCellValueFactory(new PropertyValueFactory<>("duree_max"));
        empruntsMaxColumn.setCellValueFactory(new PropertyValueFactory<>("emprunts_max"));
    ...
    private void majCategorie() throws SQLException {
        ...
        Categorie categorie = cbCategories.getSelectionModel().getSelectedItem();
        int empruntsMax = Integer.parseInt(empruntsMaxTF.getText());
        int dureeMax = Integer.parseInt(dureeMaxTF.getText());
        System.out.println(categorie.getNom()+" "+empruntsMax+" "+dureeMax);
        String query = "UPDATE categories SET emprunts_max = ?, duree_max = ? WHERE nom = ?";
